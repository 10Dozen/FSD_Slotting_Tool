function dzn_htmlInstruction() {
	var htmlText = 
	"<br><br><div>How to use?</div>" + 
    "See here: <a href='https://docs.google.com/presentation/d/1OEDrJrd2EmN4QM8mTNhtbYPKTAvoZUQhJO9mgK8XQ-0/pub?start=false&loop=false&delayms=3000' target='_blank'>Tutorial</a>" +    
    "<ol><li>Add 'ARMA FSD Tools' work folder to your Drive. Go to 'FSD Tools' menu and click <span>Create FSD Tools Folder on Drive</span></li><br><li>Copy your mission from mission.sqm file</li><li>Paste your mission to <span>INPUT: mission.sqm</span> sheet</li><br><li>Parse your mission file to get role names. Click <span>Parse Mission.sqm</span> from 'FSD Tools' menu</li><li>After your mission is parsed, check <span>Main sheet</span> to view and edit roles and squads (marked like '!  Alpha')</li><li>Check and edit additional parameters - playable sides, default settings of Feedback forms, etc.</li><br><li>When ready, confirm your data, using <span>Confirm Data</span> from 'FSD Tools' menu</li><p><b>Now you can create Forms with confirmed data. Check next steps</b></p><li>Use 'FSD Tools' -> <span>Create Slotting form COOP</span> or <span>Create Slotting form TVT</span></li><li>Enter your mission title and click OK</li><li>Do you want to get feedback after misson? Then click YES on pop-up.</li><li>Relax and wait for a while</li><li>After confirmation message appeared, check the links at sidebar (check <span>Last Created Forms</span> section) and open them in the new tab</li><p><b>Form was created and waiting for your attention. Check the values of existing items and edit them if you need it</b></p><li>When you are ready, click <span>Start Slotting form</span> from Form's 'FSD Tools' menu</li><li>Now form will be prepared for publishing. Take a minute for relax and you are almost done</li><li>Check 'Change Theme' to give your forms some kawaiiness</li><li>Publish it!</li></ol><p>If you don't want to use the form anymore - do not forget to <span>Inactivate</span> it from form's 'FSD Tools' menu - form will be closed for respondents and all triggers will be terminated.<br /> Now you can simply delete it from your drive</p>"
